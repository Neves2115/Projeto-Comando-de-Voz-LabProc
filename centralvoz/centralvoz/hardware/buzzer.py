...
MELODIES: dict[str, Melody] = {
    ...
    # "Parabens pra voce" completo: as quatro frases.
    # A terceira sobe uma oitava ("PA-ra-bens" agudo) e a quarta resolve na
    # tonica. Antes so as duas primeiras estavam aqui, e a musica parava no meio.
    "parabens": (
        # 1) Parabens pra voce
        ("do", 0.2), ("do", 0.15), ("re", 0.4), ("do", 0.4),
        ("fa", 0.4), ("mi", 0.75), ("pausa", 0.12),
        # 2) Nesta data querida
        ("do", 0.2), ("do", 0.15), ("re", 0.4), ("do", 0.4),
        ("sol", 0.4), ("fa", 0.75), ("pausa", 0.12),
        # 3) Muitas felicidades
        ("do", 0.2), ("do", 0.15), ("do5", 0.4), ("la", 0.4),
        ("fa", 0.4), ("mi", 0.4), ("re", 0.75), ("pausa", 0.12),
        # 4) Muitos anos de vida
        ("la#", 0.2), ("la#", 0.15), ("la", 0.4), ("fa", 0.4),
        ("sol", 0.4), ("fa", 0.9),
    ),
